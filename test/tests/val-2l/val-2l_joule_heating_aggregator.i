...
# Level 2: voltage aggregator for the val-2l Joule-heating membrane model.
# Uses n20_faster optimized parameters (71 steps, ~20.2% RMSPE).
...
# --- 14 local n5 optimized parameters ---
...
[MultiApps]
  ...
  [sub]
    ...
    input_files = 'val-2l_joule_heating.i'
...
[Postprocessors]
  ...
  [pp_RMSPE]
    ...
    expression = 'sqrt(combined_relative_error_sq / 10)'
    execute_on = 'TIMESTEP_END'
  []
  [pp_log_inverse_error]
    type = ParsedPostprocessor
    pp_names = 'pp_RMSPE'
    expression = 'log(1 / pp_RMSPE)'
    execute_on = 'TIMESTEP_END'
  []
[]
