...
mass_variation_percentage = (
    (
        np.max(mass_conservation_sum_encl1_encl2)
        - np.min(mass_conservation_sum_encl1_encl2)
    )
    / np.min(mass_conservation_sum_encl1_encl2)
    * 100
)
...
concentration_enclosure_1_at_interface_k10 = expt_data_k10[
    "concentration_enclosure_1_at_interface"
]
pressure_enclosure_2_at_interface_k10 = expt_data_k10[
...
ax.plot(
    TMAP8_time_k10,
    TMAP8_pressure_enclosure_1_k10,
    label=r"T$_2$ Enclosure 1",
    c="tab:red",
    linestyle="-",
)
ax.plot(
    TMAP8_time_k10,
    TMAP8_pressure_enclosure_2_k10,
    label=r"T$_2$ Enclosure 2",
    c="tab:blue",
    linestyle="-",
)
