...
ax.plot(simulation_time_TMAP7, flux_environment, linestyle='-', label=r"environment", c='tab:orange')
...
tmap_flux_for_rmspe = numerical_solution_on_experiment_input(experiment_time, simulation_time_TMAP7, simulation_flux_left_TMAP7)
