...
electron_concentration_initial_expo = -1.60701784
...
detrapping_energy_1_ev = '${units 1.24373578 eV}'
detrapping_energy_1 = '${fparse detrapping_energy_1_ev / k_B}'
trapping_site_fraction_1_expo =  -2.55734086
trapping_site_fraction_1 = ${fparse 5 * 10 ^ trapping_site_fraction_1_expo} # (-)
trapping_rate_prefactor_expo = 8.91574588
trapping_rate_prefactor = '${units ${fparse 4.8 * 10 ^ trapping_rate_prefactor_expo} 1/s}' # 9.1316e12
release_rate_profactor_expo = 1.78981096e+01
release_rate_profactor = '${units ${fparse 2.6 * 10 ^ release_rate_profactor_expo }1/s}' # 8.4e12
trapping_energy_ev = '${units 4.67088776e-01 eV}'
trapping_energy = '${fparse trapping_energy_ev / k_B}'
trap_per_free_1 = 1e0 # 1e6 # (-)
...
# chemical_reaction
delta_H_T2O = '${units -1.56376367e+05 J/mol}'
delta_S_T2O = '${units -1.37384676e+02 J/mol/K}'
delta_H_T2 = '${units -1.12177032e+05 J/mol}'
delta_S_T2 = '${units -3.69926058e+01 J/mol/K}'
# reaction_equilibrium_factor_T2_expo = -2
# reaction_equilibrium_factor_T2 = '${fparse 1 * 10 ^ reaction_equilibrium_factor_T2_expo}'
T2O_reaction_forward_value_expo = -3.04026733e+01
T2O_reaction_forward_value = '${units ${fparse 2 * 10 ^ T2O_reaction_forward_value_expo} m^4/at/s -> mum^4/at/s}'
T2_reaction_forward_value_expo = -4.40265960e+01
T2_reaction_forward_value = '${units ${fparse 2 * 10 ^ T2_reaction_forward_value_expo} m^4/at/s -> mum^4/at/s}'

# Materials diffusivities (T: diffusivity and solubility data from Hossain 2020)
diffusivity_OT_prefactor_m2s = '${units 1.90232846e-09  m^2/s}'  # '${units 1e-12 m^2/s}' # Deuterium
diffusivity_OT_prefactor = '${units ${fparse diffusivity_OT_prefactor_m2s * sqrt(3/2)} m^2/s -> mum^2/s}'  # Deuterium
diffusivity_OT_energy_ev = '${units 1.21595541e-01  eV}' # '${units 0.36 eV}' #
diffusivity_OT_energy = '${units ${fparse diffusivity_OT_energy_ev * eV_to_J * N_a} J/mol}'
diffusivity_V_O_prefactor_m2s = '${units 1.23735898e-07 m^2/s}'
diffusivity_V_O_prefactor = '${units ${diffusivity_V_O_prefactor_m2s} m^2/s -> mum^2/s}'
diffusivity_V_O_energy = '${units 1.00342570e+05 J/mol}'
diffusivity_e_prefactor_m2s = '${units 2.06292148e-02 m^2/s}'
diffusivity_e_prefactor = '${units ${diffusivity_e_prefactor_m2s} m^2/s -> mum^2/s}'
diffusivity_e_energy = '${units 9.53470966e+04 J/mol}'

# file_name = 'val-2g_no_trapping_calibrated'
