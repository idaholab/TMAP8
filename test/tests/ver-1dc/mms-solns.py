...
f_u, e_u = mms.evaluate('diff(u,t) - div(grad(u)) + diff(trapping1,t) + diff(trapping2,t) + diff(trapping3,t)', u, variable='u', trapping1=trapping1, trapping2=trapping2, trapping3=trapping3, scalars=['D', 'N', 'frac1', 'frac2', 'frac3'])
