...
ax.plot(tmap8_position,tmap8_tritium_mobile_init,label=r"$C_M(t=0)$",c='tab:green', alpha=0.5, ls=':')
ax.plot(tmap8_position,tmap8_tritium_trapped,label=r"$C_T(t=45 \mathrm{years})$",c='tab:blue', alpha=1)
ax.plot(tmap8_position,tmap8_tritium_mobile,label=r"$C_M(t=45 \mathrm{years})$",c='tab:green', alpha=1)
ax.plot(tmap8_position,tmap8_helium,label=r"$C_{He}(t=45 \mathrm{years})$",c='tab:red', alpha=1)
