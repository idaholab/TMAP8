...
ax.plot(abaqus_sol_transient_x,abaqus_sol_transient_temperature_1,label=r"ABAQUS or TMAP7 (1)",c='b', linestyle='--')
ax.plot(abaqus_sol_transient_x,abaqus_sol_transient_temperature_2,label=r"ABAQUS or TMAP7 (2)",c='r', linestyle='-.')
ax.set_xlabel(u'Distance (m)')
ax.set_ylabel(r"Temperature (K)")
ax.legend(loc="best")
ax.set_xlim(left=0)
...
ax.plot(abaqus_sol_transient_t,abaqus_sol_transient_temperature_at_x,label=r"ABAQUS)",c='b', linestyle='--')
ax.plot(abaqus_sol_transient_t,tmap7_sol_transient_temperature_at_x,label=r"TMAP7",c='r', linestyle='-.')
ax.set_xlabel(u'Distance (m)')
ax.set_ylabel(r"Temperature (K)")
ax.legend(loc="best")
ax.set_xlim(left=0)
