...
mass_conservation_sum_encl1_encl2_k10 = expt_data_k10[
...
line1 = ax.plot(
    TMAP8_time_k10,
    TMAP8_pressure_H2_enclosure_1_k10,
    label=r"H$_2$ Enclosure 1",
    c="tab:red",
    linestyle="-",
)
line2 = ax.plot(
    TMAP8_time_k10,
    TMAP8_pressure_T2_enclosure_1_k10,
    label=r"T$_2$ Enclosure 1",
    c="tab:orange",
    linestyle="--",
)
line3 = ax.plot(
    TMAP8_time_k10,
    TMAP8_pressure_HT_enclosure_1_k10,
    label=r"HT Enclosure 1",
    c="tab:purple",
    linestyle="-",
)
...
line4 = ax2.plot(
    TMAP8_time_k10,
    TMAP8_pressure_H2_enclosure_2_k10,
    label=r"H$_2$ Enclosure 2",
    c="tab:blue",
    linestyle="-",
)
line5 = ax2.plot(
    TMAP8_time_k10,
    TMAP8_pressure_T2_enclosure_2_k10,
    label=r"T$_2$ Enclosure 2",
    c="tab:green",
    linestyle="--",
)
line6 = ax2.plot(
    TMAP8_time_k10,
    TMAP8_pressure_HT_enclosure_2_k10,
    label=r"HT Enclosure 2",
    c="tab:cyan",
    linestyle="-",
)
...
ax.plot(
    TMAP8_time_k10[1:],
    concentration_ratio_H2_k10[1:],
    label=r"Concentration Ratio (TMAP8)",
    color="tab:blue",
    linestyle="-",
)
ax.plot(
    TMAP8_time_k10[1:],
    solubility_ratio,
    label=r"Solubility Ratio (Analytical)",
    color="tab:red",
    linestyle="--",
)
...
ax.grid(which="major", color="0.65", linestyle="--", alpha=0.3)
mass_variation_percentage = (
    (
        np.max(mass_conservation_sum_encl1_encl2_k10)
...
ax.set_xlim(0, TMAP8_time_k10.max())
ax.set_ylabel(
    r"Equilibrium constant $P_{\mathrm{HT}} / \sqrt{P_{\mathrm{H}_2} P_{\mathrm{T}_2}}$"
)
ax.set_ylim(bottom=0)
ax.legend(loc="best")
ax.grid(which="major", color="0.65", linestyle="--", alpha=0.3)
print(
    "Relative variation to equilibrium constant in enclosure 1",
    abs(equilibrium_constant_encl_1[len(equilibrium_constant_encl_1) - 1] - 2)
    / 2
    * 100,
)
print(
    "Relative variation to equilibrium constant in enclosure 2",
    abs(equilibrium_constant_encl_2[len(equilibrium_constant_encl_2) - 1] - 2)
    / 2
    * 100,
)
