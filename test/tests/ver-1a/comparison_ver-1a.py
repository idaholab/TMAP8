...
ax.plot(
    time_analytical,
    analytical_release_fraction_TMAP4,
...
RMSE = np.sqrt(
    np.mean(
        (tmap8_release_fraction_right - analytical_release_fraction_TMAP4)[idx:] ** 2
    )
)
...
ax.minorticks_on()
plt.savefig(
    "ver-1a_comparison_analytical_TMAP4_release_fraction.png",
    bbox_inches="tight",
    dpi=300,
)
plt.close(fig)
...
ax.plot(
    time_analytical,
    analytical_release_fraction_TMAP7,
...
RMSE = np.sqrt(
    np.mean(
        (tmap8_release_fraction_left - analytical_release_fraction_TMAP7)[idx:] ** 2
    )
)
...
ax.minorticks_on()
plt.savefig(
    "ver-1a_comparison_analytical_TMAP7_release_fraction.png",
    bbox_inches="tight",
    dpi=300,
)
plt.close(fig)
