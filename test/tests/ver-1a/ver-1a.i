# Validation Problem #1a from TMAP4/TMAP7 V&V document
...
kb = 1.38065e-23 # Boltzmann constant J/K - note that we use the same number of digits as in TMAP7
R = 8.314 # Gas constant J/mol/K - note that we use the same number of digits as in TMAP4

# Data used in TMAP4/TMAP7 case
temperature = 2.373e3 # K
