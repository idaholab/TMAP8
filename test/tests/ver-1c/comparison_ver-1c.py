...
ax.text(
    20, get_c_analytical_4(10, 20), "RMSPE = %.2f " % RMSPE + "%", fontweight="bold"
)
...
ax.plot(
    tmap_time_7,
    analytical_conc0_25_7,
    label=r"Analytical x=0.25 m",
    c="tab:brown",
    linestyle="--",
    dashes=(5, 5),
)
...
ax.text(
    20, get_c_analytical_7(0.25, 20), "RMSPE = %.2f " % RMSPE + "%", fontweight="bold"
)
...
ax.text(
    20, get_c_analytical_7(10, 20), "RMSPE = %.2f " % RMSPE + "%", fontweight="bold"
)
...
ax.text(
    20, get_c_analytical_7(12, 20), "RMSPE = %.2f " % RMSPE + "%", fontweight="bold"
)
