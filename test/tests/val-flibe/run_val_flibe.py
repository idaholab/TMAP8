...
#command_to_run = " ~/projects/TMAP8/tmap8-opt -i val-xx.i"

# Experimental data
# p_exp = np.array([1210,538,315,171,1210,538,315,1210,538,1210])
# T_exp = np.array([700,700,700,700,650,650,650,600,600,550])

# p_exp = np.array([1210,538,315,171])
# T_exp = np.array([700,700,700,700])

# p_exp = np.array([1210,538,315])
# T_exp = np.array([650,650,650])

# p_exp = np.array([1210,538])
# T_exp = np.array([600,600])
