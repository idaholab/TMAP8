...
[ActionComponents]
  ...
  [structure_second]
    type = Structure1D
    species = 'trapped_other'
    species_initial_concentrations = '1'

    physics = 'mobile_diff trapped_other'
    temperature = '300'

    # Material properties
    property_names = 'alpha_t  N  trapping_energy Ct0 trap_per_free alpha_r detrapping_energy diff'
    property_values = '2e15   ${N} 0               0.1 1             3e13    100                1'

    # Boundary conditions
    fixed_value_bc_variables = 'mobile'
    fixed_value_bc_boundaries = 'structure_second_left structure_second_right'
    fixed_value_bc_values = '${fparse 3.1622e18 / cl} 0'
...
[Postprocessors]
  ...
  [ave_trapped_other]
    type = ElementAverageValue
    variable = 'trapped_other'
    block = 'structure_second'
  []
  [ave_mobile]
    type = ElementAverageValue
    variable = 'mobile'
