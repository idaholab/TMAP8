...
### C_total_j       total Hconcentraion in "j" material, where j = CuCrZr, Cu, W
###
...
# # Mesh generated "2DMonoblock.e" file
# [Mesh]
#     file = 2DMonoblock.e
# []
...
[Problem]
    ...
    # group_variables = 'C_mobile_W C_trapped_W; C_mobile_Cu C_trapped_Cu; C_mobile_CuCrZr C_trapped_CuCrZr'
[]
...
[AuxVariables]
    ...
    [Sc_S_total_Cu]
        ...
        block = 3
    []
    ############################## AuxVariable for CuCrZr (block = 2)
    [Sc_C_mobile_CuCrZr]
        initial_condition = 0
        block = 2
    []
...
[NodalKernels]
    ...
    [release_W]
        ...
        temp = temperature
        # trapping_energy = 9863.9    # = 0.85 eV    E.A. Hodille et al 2021 Nucl. Fusion 61 126003, trap 1
        trapping_energy = 11604.6   # = 1.00 eV    E.A. Hodille et al 2021 Nucl. Fusion 61 126003, trap 2
        variable = C_trapped_W
    []
    ...
    [release_Cu]
        ...
        alpha_r = 8.4e12    # 1.0e13
        temp = temperature
        trapping_energy = 5802.3    # = 0.50eV  R. Delaporte-Mathurin et al 2021 Nucl. Fusion 61 036038, trap 3
        variable = C_trapped_Cu
    []
    ...
    [release_CuCrZr]
        ...
        alpha_r = 8.4e12    # 1.0e13
        temp = temperature
        trapping_energy = 5802.3    # = 0.50eV  R. Delaporte-Mathurin et al 2021 Nucl. Fusion 61 036038, trap 4
        # trapping_energy = 9631.8   # = 0.83 eV  R. Delaporte-Mathurin et al 2021 Nucl. Fusion 61 036038, trap 5
        variable = C_trapped_CuCrZr
    []
[]
...
[Materials]
    ...
    [solubility_W]
        ...
        coupled_variables = 'temperature'
        block = 4
        # expression = '2.95e-5 *exp(-12069.0/temperature)'              # H solubility in W = (1.87e24)/(6.338e28) [#/m^3]
        expression = '2.95e-5 *exp(-12069.0/temperature) + 4.95e-8 * exp(-6614.6/temperature)'    # H solubility in W = (1.87e24)/(6.338e28) [#/m^3]
        outputs = all
    []
    ...
    [solubility_Cu]
        ...
        coupled_variables = 'temperature'
        block = 3
        expression = '4.95e-5*exp(-6614.6/temperature)'    # H solubility in Cu = (3.14e24)/(6.338e28) [#/m^3]
        outputs = all
    []
    ...
    [solubility_CuCrZr]
        ...
        coupled_variables = 'temperature'
        block = 2
        expression = '6.75e-6*exp(-4525.8/temperature)'    # H solubility in CuCrZr = (4.28e23)/(6.338e28) [#/m^3]
        outputs = all
    []
...
[Postprocessors]
    ...
    #     value = F_recombination
    #     scaling_factor = 3.491e10   # (1.0e3)*(1.0e3)*(6.338e28)/(6.02e23)/(3.01604928) [gram(T)/m^2]
    # []
    [F_permeation]
        type = SideDiffusiveFluxAverage
        boundary = '2to1'
    ...
    #     function = 'diff_W * dt / h_W^2'
    #     pp_names = 'dt h_W diff_W'
    # []
    ...
    [ScInt_C_trapped_Cu]
        ...
        scaling_factor = 3.44e10   # (1.0e3)*(1.0e3)*(6.338e28)/(6.02e23)/(3.01604928) [gram(T)/m^2]
    []
    [Int_C_total_Cu]
        type = ElementIntegralVariablePostprocessor
        variable = C_total_Cu
    ...
    #     type = ElementAverageValue
    #     block = 3
    #     variable = diffusivity_Cu
    # []
    # [sol_Cu]
    #     type = ElementAverageValue
    #     block = 3
    #     variable = solubility_Cu
    # []
    # [h_Cu]
    #     type = AverageElementSize
    #     block = 3
    ...
    # [Fo_Cu]
    #     type = ParsedPostprocessor
    #     function = 'diff_Cu * dt / h_Cu^2'
    #     pp_names = 'dt h_Cu diff_Cu'
    # []
    ...
    #     type = ElementAverageValue
    #     block = 2
    #     variable = diffusivity_CuCrZr
    # []
    # [sol_CuCrZr]
    #     type = ElementAverageValue
    #     block = 2
    #     variable = solubility_CuCrZr
    # []
    # [h_CuCrZr]
    #     type = AverageElementSize
    #     block = 2
    ...
    # [Fo_CuCrZr]
    #     type = ParsedPostprocessor
    #     function = 'diff_CuCrZr * dt / h_CuCrZr^2'
    #     pp_names = 'dt h_CuCrZr diff_CuCrZr'
    # []
    ...
    # [C_1mm_trapped1_W]
    #     type = PointValue
    #     variable = C_trapped1_W
    #     point = '0 13.0e-3 0'
    # []
    # [C_1mm_trapped2_W]
    #     type = PointValue
    #     variable = C_trapped2_W
    #     point = '0 13.0e-3 0'
    # []
    # [C_1mm_trapped_W]
    #     type = PointValue
    ...
    # [gold_solubility_ratio_4to3]
    #     type = ParsedPostprocessor
    #     function = 'sol_W / sol_Cu'
    #     pp_names = 'sol_W sol_Cu'
    # []
    # [interface_4to3]
    ...
    # [variable_ratio_43]
    #     type = ParsedPostprocessor
    #     function = 'interface_4to3 / interface_3to4'
    #     pp_names = 'interface_4to3 interface_3to4'
    # []
    # [gold_solubility_ratio_3to2]
    #     type = ParsedPostprocessor
    #     function = 'sol_Cu / sol_CuCrZr'
    #     pp_names = 'sol_Cu sol_CuCrZr'
    # []
    # [interface_3to2]
    #     type = SideAverageValue
    #     boundary = '3to2'
    ...
    # [variable_ratio_32]
    #     type = ParsedPostprocessor
    #     function = 'interface_3to2 / interface_2to3'
    #     pp_names = 'interface_3to2 interface_2to3'
    # []
[]
...
[VectorPostprocessors]
    [line]
        ...
        # variable = 'C_total_W C_total_Cu C_total_CuCrZr'
        # variable = 'Sc_C_total_W Sc_C_total_Cu Sc_C_total_CuCrZr'
...
[Executioner]
    ...
    # end_time = 1.0
    # end_time = 1.0e2
    # end_time = 6.0e2    #    1 plasma shot of 6.0e2 s = 4.0e2 steady-state plasma (SSP)
    # end_time = 1.6e3   #    1 ITER shot (6.0e2 s plasma, 4.0e2 SSP)
    # end_time = 3.2e3   #    2 ITER shots (1.2e3 s plasma, 8.0e2 SSP)
    # end_time = 8.0e3   #    5 ITER shots (3.0e3 s plasma, 2.0e3 SSP)
    # end_time = 1.6e4   #   10 ITER shots (6.0e3 s plasma, 4.0e3 SSP)
    # end_time = 3.2e4   #   20 ITER shots (1.2e4 s plasma, 8.0e3 SSP)
    # end_time = 4.0e4   #   25 ITER shots (1.5e4 s plasma, 1.0e4 SSP)
    end_time = 8.0e4   #   50 ITER shots (3.0e4 s plasma, 2.0e4 SSP)
    # end_time = 1.6e5   #  100 ITER shots (6.0e4 s plasma, 4.0e4 SSP)
    # end_time = 3.2e5   #  200 ITER shots (1.2e5 s plasma, 8.0e4 SSP)
    # end_time = 4.0e5   #  250 ITER shots (1.5e5 s plasma, 1.0e5 SSP)
    # end_time = 8.0e5   #  500 ITER shots (3.0e5 s plasma, 2.0e5 SSP)
    # end_time = 1.6e6   # 1000 ITER shots (6.0e5 s plasma, 4.0e5 SSP)
    ...
    #                     if((t % 1600) <  610.0,   2,
    #                     if((t % 1600) < 1500.0,  10,
    #                     if((t % 1600) < 1600.0,  10,  1)))))))))'
    # []
    # [TimeStepper]
    #     type = FunctionDT
    #     function =     'if((t % 1600) <   10.0,  10,
    #                     if((t % 1600) <   90.0,  20,
    #                     if((t % 1600) <  110.0,  10,
    #                     if((t % 1600) <  480.0,  20,
    #                     if((t % 1600) <  500.0,  10,
    #                     if((t % 1600) <  590.0,   2,
    #                     if((t % 1600) <  610.0,  10,
    #                     if((t % 1600) < 1500.0, 100,
    #                     if((t % 1600) < 1600.0,  20,  1)))))))))'
    # []
    [TimeStepper]
        type = FunctionDT
    ...
    #     dt = 1.0e0                  # 1.0e0
    #     optimal_iterations = 10     # 4
    #     growth_factor = 1.5         # 1.1
    #     cutback_factor = 0.5        # 0.5
...
[Outputs]
    ...
    csv = true
    checkpoint = true
    # hide = 'Int_C_mobile_W Int_C_trapped_W Int_C_total_W sol_W diff_W h_W Fo_W
    #         dt max_time_step_size_pp'
    # hide = 'Int_C_mobile_W Int_C_trapped_W Int_C_total_W sol_W diff_W h_W Fo_W
    #         Int_C_mobile_Cu Int_C_trapped_Cu Int_C_total_Cu sol_Cu diff_Cu h_Cu Fo_Cu
    #         gold_solubility_ratio_4to3 interface_4to3 interface_3to4 variable_ratio_43
    #         time dt max_time_step_size_pp F_recombination F_permeation'
    hide = 'time dt
    ...
    # hide = 'Int_C_mobile_W Int_C_trapped_W Int_C_total_W Sc_C_mobile_W Sc_C_trapped_W Sc_C_total_W
    #         S_empty_W S_trapped_W S_total_W Sc_S_empty_W Sc_S_trapped_W Sc_S_total_W
    #         sol_W diff_W h_W Fo_W
    #         Int_C_mobile_Cu Int_C_trapped_Cu Int_C_total_Cu Sc_C_mobile_Cu Sc_C_trapped_Cu Sc_C_total_Cu
    #         S_empty_Cu S_trapped_Cu S_total_Cu Sc_S_empty_Cu Sc_S_trapped_Cu Sc_S_total_Cu
    #         sol_Cu diff_Cu h_Cu Fo_Cu
    #         Int_C_mobile_CuCrZr Int_C_trapped_CuCrZr Int_C_total_CuCrZr Sc_C_mobile_CuCrZr Sc_C_trapped_CuCrZr Sc_C_total_CuCrZr
    #         S_empty_CuCrZr S_trapped_CuCrZr S_total_CuCrZr Sc_S_empty_CuCrZr Sc_S_trapped_CuCrZr Sc_S_total_CuCrZr
    #         sol_CuCrZr diff_CuCrZr h_CuCrZr Fo_CuCrZr
    #         gold_solubility_ratio_4to3 interface_4to3 interface_3to4 variable_ratio_43
    #         gold_solubility_ratio_3to2 interface_3to2 interface_2to3 variable_ratio_32
    #         time dt max_time_step_size_pp F_recombination F_permeation'
    [dof]
      type = DOFMap
      execute_on = initial
