...
To vary the material properties used in each `Physics`, one can set the [!param](/ActionComponents/Structure1D/material_property_names) and [!param](/ActionComponents/Structure1D/material_property_values) parameters in the `Structure1D`.
...
Using the [!param](/ActionComponents/Structure1D/dirichlet_bc_boundaries),
[!param](/ActionComponents/Structure1D/dirichlet_bc_variables) and
[!param](/ActionComponents/Structure1D/dirichlet_bc_values) parameters of the `Structure1D`,
