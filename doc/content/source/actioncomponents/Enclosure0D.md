...
To vary the material properties used in each `Physics`, one can set the [!param](/ActionComponents/Structure1D/material_property_names) and [!param](/ActionComponents/Structure1D/material_property_values) parameters in the `Enclosure0D`.
