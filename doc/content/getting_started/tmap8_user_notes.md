...
scales are closer to unity when using SI units. Moreover, multiple species,
...
given chemical species. However, for a good multiphysics multivariable solve, we
want the numerical concentrations of the two species to be about the same. If
for instance, the concentration of the trapped species is roughly 1000 times
larger than the mobile species, we can specify `trap_per_free = 1000`. This is
effectively changing the concentration of the trapped species from being measured
