...
- [Windows (experimental)](https://mooseframework.inl.gov/getting_started/installation/windows.html) (Consider a virtual container [using Docker instead!](getting_started/docker.md exact=True))
