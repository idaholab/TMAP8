...
\begin{equation}
    \label{eq:diffusion}
    \frac{\partial C_M}{\partial t} = \nabla D \nabla C_M + S + f_{T/M} \cdot \sum_{i=1}^{6} \frac{\partial C_{T_i}}{\partial t}
\end{equation}
...
\begin{equation}
    ...
    \frac{\partial C_{T_i}}{\partial t} = \alpha_t^i  \frac {C_{T_i}^{empty} C_M } {(N \cdot f_{T/M})} - \alpha_r^i C_{T_i}
\end{equation}
