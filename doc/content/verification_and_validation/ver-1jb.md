...
\end{equation}
where $R$ is the ideal gas constant in J/K/mol from [Physical Constants](utils/TMAP8Constants.md) and $T=300$ K is the temperature of the domain.
...
\end{equation}
where $k_b$ is the Boltzmann constant in eV/K from [Physical Constants](utils/TMAP8Constants.md).
