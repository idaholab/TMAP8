...
!media comparison_ver-1kc-2.py
       ...
       caption=Evolution of species pressure over time governed by Sieverts' law with $K = 10/\sqrt{RT}$ and $\eta = \sqrt{2K_1/K_2}$. As expected, the pressures for $H_2$ and $T_2$ in Enclose 1 overlap, and so do the pressures for $H_2$ and $T_2$ in Enclose 2.
