...
!style halign=left
The input file for this case can be obtained by updating the initial pressure for B$_2$ in [!file](/ver-1ia.i), which is the approach used to create tests in TMAP8 at [!file](/ver-1ib/tests).
