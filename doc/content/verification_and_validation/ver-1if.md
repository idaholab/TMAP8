...
This case uses starting pressures of $1e4$ Pa of H$_2$ and $1e5$ Pa of D$_2$ and no HD. $K_d$ was specified to be $1.858e24/\sqrt{T}$ atom/m$^2$/s/pa. $K_s$ was specified to be $1e24$ atom/m$^3$/pa$^0.5$. Temperature was 1000 K, the surface area for reaction was a 5 cm $\times$ 5 cm square, and the enclosure volume was 1 m$^3$.
